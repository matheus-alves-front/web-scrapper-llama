...
Display the currently active [Quasar CLI](https://quasar.dev/start/quasar-cli) version. Only rendered when the current or
...
## Template ( [info](https://ohmyposh.dev/docs/configuration/templates)) [​](https://ohmyposh.dev/docs/segments/cli/quasar\#template-info "Direct link to template-info")
...
### Properties [​](https://ohmyposh.dev/docs/segments/cli/quasar\#properties-1 "Direct link to Properties")
...
- [Template (info)](https://ohmyposh.dev/docs/segments/cli/quasar#template-info)
  - [Properties](https://ohmyposh.dev/docs/segments/cli/quasar#properties-1)