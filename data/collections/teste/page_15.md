...
## Template ( [info](https://ohmyposh.dev/docs/configuration/templates)) [​](https://ohmyposh.dev/docs/segments/languages/perl\#template-info "Direct link to template-info")
...
### Properties [​](https://ohmyposh.dev/docs/segments/languages/perl\#properties-1 "Direct link to Properties")
