...
- [General configuration](https://ohmyposh.dev/docs/configuration/general) \- Main configuration documentation
- [Installation](https://ohmyposh.dev/docs/installation/windows) \- Installing Oh My Posh
