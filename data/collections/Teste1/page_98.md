...
[Completions](https://docs.python.org/3/library/idle.html#completions) in the Editing and navigation section below.
...
function parameter hints. See [Calltips](https://docs.python.org/3/library/idle.html#calltips) in the
...
Turn _leading_ stretches of spaces into tabs. (Note: We recommend using
...
non-whitespace character of a line by applying [`str.rstrip()`](https://docs.python.org/3/library/stdtypes.html#str.rstrip "str.rstrip") to each line,
...
Do [Check Module](https://docs.python.org/3/library/idle.html#check-module). If no error, restart the shell to clean the
...
Same as [Run Module](https://docs.python.org/3/library/idle.html#run-module), but run the module with customized
settings. _Command Line Arguments_ extend [`sys.argv`](https://docs.python.org/3/library/sys.html#sys.argv "sys.argv") as if passed
...
[Setting preferences](https://docs.python.org/3/library/idle.html#preferences) under Help and preferences.
...
[Code Context](https://docs.python.org/3/library/idle.html#code-context) in the Editing and Navigation section
below.
...
preferences (see [Setting preferences](https://docs.python.org/3/library/idle.html#preferences)).
...
the General tab. See the [Help sources](https://docs.python.org/3/library/idle.html#help-sources) subsection below
...
The Shell window also has an output squeezing facility explained in the _Python_
_Shell window_ subsection below.
...
[Format menu](https://docs.python.org/3/library/idle.html#format-menu).
...
For filenames in the root directory, type [`os.sep`](https://docs.python.org/3/library/os.html#os.sep "os.sep") or
[`os.altsep`](https://docs.python.org/3/library/os.html#os.altsep "os.altsep") immediately after an opening quote. (On Windows,
...
of an _accessible_ function. A function name expression may include
...
[`SyntaxError`](https://docs.python.org/3/library/exceptions.html#SyntaxError "SyntaxError") when multiple statements are compiled as if they were one.
...
IDLE also highlights the [soft keywords](https://docs.python.org/3/reference/lexical_analysis.html#soft-keywords) [`match`](https://docs.python.org/3/reference/compound_stmts.html#match),
...
the environment variables `IDLESTARTUP` or [`PYTHONSTARTUP`](https://docs.python.org/3/using/cmdline.html#envvar-PYTHONSTARTUP).
...
No editor window is opened, even if that is the default set in the _Options_ dialog.
...
and [`str.join()`](https://docs.python.org/3/library/stdtypes.html#str.join "str.join") can help combine fields and lines.
